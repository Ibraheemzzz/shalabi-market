...
const getSalesReport = async (req, res) => {
  try {
    ...
    logger.error('Get sales report error:', { error: error.message, stack: error.stack });
...
const getTopProducts = async (req, res) => {
  try {
    ...
    logger.error('Get top products error:', { error: error.message, stack: error.stack });
...
const getLowStockProducts = async (req, res) => {
  try {
    ...
    logger.error('Get low stock products error:', { error: error.message, stack: error.stack });
...
const getProfitReport = async (req, res) => {
  try {
    ...
    logger.error('Get profit report error:', { error: error.message, stack: error.stack });
...
const getCategorySales = async (req, res) => {
  try {
    ...
    logger.error('Get category sales error:', { error: error.message, stack: error.stack });
...
const getOrderStatusDistribution = async (req, res) => {
  try {
    ...
    logger.error('Get order status distribution error:', { error: error.message, stack: error.stack });
