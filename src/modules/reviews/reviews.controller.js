...
const getProductReviews = async (req, res) => {
  try {
    ...
    logger.error('Get reviews error:', { error: error.message, stack: error.stack });
...
const getAllReviews = async (req, res) => {
  try {
    ...
    logger.error('Get all reviews error:', { error: error.message, stack: error.stack });
    return serverErrorResponse(res, 'Failed to get reviews');
  }
};
...
const toggleReviewVisibility = async (req, res) => {
  try {
    ...
    logger.error('Toggle review visibility error:', { error: error.message, stack: error.stack });
